...
import { AiFillHome, AiOutlineInbox, AiOutlineNotification, AiOutlineUser } from "react-icons/ai"
import { BiHash, BiSearchAlt, BiPoll, BiMessageAltAdd, BiMessageSquareDetail, BiBookContent } from "react-icons/bi"
import { RiAdminLine, RiHashtag, RiUserSettingsLine } from "react-icons/ri"
import { BsBell, BsBookmark, BsThreeDots} from "react-icons/bs"
import { HiHashtag, HiOutlineClipboardList, HiOutlineDotsCircleHorizontal, HiOutlineUserGroup } from "react-icons/hi"
      ...
      <>
        <div className='hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full border-r border-gray-400 pr-0 xl:pr-8 overflow-y-scroll'>
            ...
            <div className='space-y-2 mt-4 mb-2.5 xl:ml-24 text-[#16181C]'>
              <div onClick={() => router.push('/dashboard-for-admin/admin')}>
                <SidebarLink text="Admin" Icon={RiAdminLine} />
              </div>
